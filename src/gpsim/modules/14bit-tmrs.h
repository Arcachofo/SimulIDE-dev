...
public:
    ...
    CCPRH(Processor *pCpu, const char *pName );
    void put(uint new_value);
    void put_value(uint new_value);
    uint get();
};

class CCPRL : public SfrReg
{
public:
    ...
    CCPRL(Processor *pCpu, const char *pName );
};
...
public:
    ...
    ECCPAS(Processor *pCpu, const char *pName );
    ~ECCPAS();
...
public:
    ...
    PWM1CON(Processor *pCpu, const char *pName );
    ~PWM1CON();
...
public:
    ...
    PSTRCON(Processor *pCpu, const char *pName );
    ~PSTRCON();
...
class CCPCON : public SfrReg, public TriggerObject, public apfpin
{
public:
    CCPCON( Processor* pCpu, const char* pName);
    ~CCPCON();
...
{
public:
    PWMxCON(Processor *pCpu, const char *pName, char _index=1);
    ...
    void set_pwmdc(SfrReg *_pwmdcl, SfrReg *_pwmdch)
...
class TRISCCP : public SfrReg
{
public:

    TRISCCP(Processor *pCpu, const char *pName );
    enum
    {
        TT1CK = 1<<0,
        TCCP  = 1<<2
...
class DATACCP : public SfrReg
{
public:
    DATACCP(Processor *pCpu, const char *pName );
    enum
    {
        TT1CK = 1<<0,
        DCCP  = 1<<2
...
public:
    ...
    T1CON(Processor *pCpu, const char *pName );
    ~T1CON();
...
class T1GCON : public SfrReg, public apfpin
{
public:
    ...
    T1GCON(Processor *pCpu, const char *pName,  T1CON_G *t1con_g=0);
    ~T1GCON();
...
public:
    ...
    T1CON_G(Processor *pCpu, const char *pName);
    ~T1CON_G();
...
public:
    ...
    TMRH(Processor *pCpu, const char *pName );
};

class TMR1CapComRef;

class TMRL : public SfrReg, public TriggerObject, public SignalSink
{
public:
    ...
    TMRL(Processor *pCpu, const char *pName );
    ~TMRL();
...
class PR2 : public SfrReg
{
public:

    TMR2 *tmr2;

    PR2(Processor *pCpu, const char *pName );
    void put(uint new_value);
};
...
public:
    ...
    T2CON(Processor *pCpu, const char *pName );
...
{
public:
    T2CON_64(Processor *pCpu, const char *pName )
        : T2CON(pCpu, pName)
    {
    }
    virtual uint get_pre_scale()
...
//---------------------------------------------------------
// TMR2 - Timer
class TMR2 : public SfrReg, public TriggerObject
{
protected:
...
public:
    ...
    virtual void callback();
    virtual void callback_print();
    TMR2(Processor *pCpu, const char *pName );
    ~TMR2();
...
public:
    ...
    CCPTMRS14(Processor *pCpu, const char *pName );
