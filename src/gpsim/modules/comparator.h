...
public:
    ...
    VRCON(Processor *pCpu, const char *pName);
    ~VRCON();
...
//
class VRCON_2 : public SfrReg
{
public:
    VRCON_2( Processor *pCpu, const char *pName );
    ~VRCON_2();
    ...
    virtual void put( uint new_vrcon );
...
public:
    ...
    CM_stimulus(CMCON *arg, const char *n=0, double _Vth=0.0, double _Zth=1e12 );
    ~CM_stimulus();
...
public:
    ...
    CMv2_stimulus(CM2CON1_V2 *arg, const char *n=0, double _Vth=0.0, double _Zth=1e12 );
    ~CMv2_stimulus();
...
public:
    ...
    CMCON1(Processor *pCpu, const char *pName );
    ~CMCON1();
...
class CMCON : public SfrReg
{
public:
    CMCON(Processor *pCpu, const char *pName );
    ~CMCON();
...
public:
    ...
    SRCON(Processor *pCpu, const char *pName );
    ~SRCON(){}
};
...
public:
    ...
    CM2CON1(Processor *pCpu, const char *pName );
    ~CM2CON1(){}
};
...
class CMxCON0_base : public SfrReg
{
public:
    CMxCON0_base(Processor *pCpu, const char *pName, uint _cm, ComparatorModule2 *cmModule);
    ~CMxCON0_base();
...
public:
    ...
    CMxCON0(Processor *pCpu, const char *pName, uint x, ComparatorModule2 *);
    ~CMxCON0();
    void put(uint);
...
public:
    ...
    CMxCON0_V2(Processor *pCpu, const char *pName, uint _cm, ComparatorModule2 *cmModule);
    ~CMxCON0_V2();
    virtual void put(uint);
    virtual double get_Vpos();
    virtual double get_Vneg();
...
class CMxCON1_base : public SfrReg
{
public:
    enum {
        NEG	= 0,
    ...
    CMxCON1_base(Processor *pCpu, const char *pName,  uint _cm, ComparatorModule2 *);
    ~CMxCON1_base();
...
public:
    ...
    CMxCON1(Processor *pCpu, const char *pName,  uint _x, ComparatorModule2 *);
    ~CMxCON1();
...
public:
    ...
    CM2CON1_V2(Processor *pCpu, const char *pName, ComparatorModule2 * cmModule);
    ~CM2CON1_V2();
...
public:
    ...
    CM2CON1_V3(Processor *pCpu, const char *pName, uint _cm, ComparatorModule2 * cmModule) :
        CMxCON1_base(pCpu, pName, _cm, cmModule), m_vrcon(0){}
    ~CM2CON1_V3(){}
...
{
public:
    CM2CON1_V4( Processor *pCpu, const char *pName, uint _cm, ComparatorModule2* cmModule ) ;
    ~CM2CON1_V4();
...
class CMOUT : public SfrReg
{
public:
    void put(uint val) { return;} // Read only by user

    CMOUT( Processor *pCpu, const char *pName )
        : SfrReg( pCpu, pName ) {}
};
