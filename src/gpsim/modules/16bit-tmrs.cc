...
// T5CON
//--------------------------------------------------
T5CON::T5CON(Processor *pCpu, const char *pName )
    : T1CON(pCpu, pName), t1gcon(nullptr)
{
}
...
CCPTMRS0::CCPTMRS0(CCPTMRS *_ccptmrs, Processor *pCpu, const char *pName )
    : SfrReg(pCpu, pName ), bit_mask(0xdb), ccptmrs(_ccptmrs)
{}
CCPTMRS0::~CCPTMRS0()
{
}
...
CCPTMRS1::CCPTMRS1(CCPTMRS *_ccptmrs, Processor *pCpu, const char *pName )
    : SfrReg(pCpu, pName ), bit_mask(0x0f), ccptmrs(_ccptmrs)
{}
CCPTMRS1::~CCPTMRS1()
{
}
...
CCPTMRS::CCPTMRS(Processor *pCpu)
    : ccptmrs0(this, pCpu, "ccptmrs0" ),
      ccptmrs1(this, pCpu, "ccptmrs1" ),
      t2(0), t4(0), t6(0),
