...
//--------------------------------------------------
INTCON::INTCON(Processor *pCpu, const char *pName)
    : SfrReg(pCpu, pName )
{
    in_interrupt = false;
}
...
//----------------------------------------------------------------------
//----------------------------------------------------------------------
INTCON2::INTCON2(Processor *pCpu, const char *pName )
    : SfrReg(pCpu, pName ), m_bsRBPU(0)
{}
...
//----------------------------------------------------------------------
//----------------------------------------------------------------------
INTCON3::INTCON3(Processor *pCpu, const char *pName )
    : SfrReg(pCpu, pName )
{}
...
//----------------------------------------------------------------------
//----------------------------------------------------------------------
INTCON_14_PIR::INTCON_14_PIR(Processor *pCpu, const char *pName )
    : INTCON(pCpu, pName ),
...
//
//----------------------------------------------------------------------
INTCON_16::INTCON_16(Processor *pCpu, const char *pName )
    : INTCON(pCpu, pName ),
