...
{
public:
    SfrReg ufrml, ufrmh, uir,  uie,  ueir,  ueie,  ustat,  ucon,
...
{
public:
    RegZero( Processor*_cpu, const char *_name=0 ):
        Register(_cpu, _name) {}
