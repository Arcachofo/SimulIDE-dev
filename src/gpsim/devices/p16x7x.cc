...
//------------------------------------------------------------------------
//
P16C71::P16C71(const char *_name )
    : P16X8X(_name ),
      adcon0(this,"adcon0" ),
      adcon1(this,"adcon1" ),
      adres(this,"adres" )
...
{
    add_SfrReg(&adcon0, 0x08, RegisterValue(0,0));
    add_SfrReg(&adcon1, 0x88, RegisterValue(0,0));

    add_SfrReg(&adres,  0x09, RegisterValue(0,0));
...
P16x71x::P16x71x(const char *_name )
    : _14bit_processor(_name ),
      ...
      adres(this,"adres" )
{
    pir1 = new PIR1v2(this,"pir1", &intcon_reg, &pie1);
...
void P16x71x::create_sfr_map()
{
    ...
    //add_SfrReg(pclath,  0x8a, RegisterValue(0,0));
...
void P16x71x::create_iopin_map()
{
    ...
    assign_pin( 3, m_porta->addPin( new IOPIN("porta4", OPEN_COLLECTOR),4) );

    createMCLRPin(4);
    assign_pin( 5, 0);
    assign_pin( 6, m_portb->addPin(new IO_bi_directional_pu("portb0"),0));
    assign_pin( 7, m_portb->addPin(new IO_bi_directional_pu("portb1"),1));
    assign_pin( 8, m_portb->addPin(new IO_bi_directional_pu("portb2"),2));
    assign_pin( 9, m_portb->addPin(new IO_bi_directional_pu("portb3"),3));
...
void P16C712::create_sfr_map()
{
    ...
    add_SfrReg(&trisccp, 0x87, RegisterValue(0xff,0));
    add_SfrReg(&dataccp, 0x07, RegisterValue(0x00,0));
}
...
P16C712::P16C712(const char *_name )
    : P16x71x(_name ),
      trisccp(this, "trisccp" ),
      dataccp(this, "dataccp" )
{
}
...
P16C712::~P16C712()
{
    ...
    remove_SfrReg(&adcon1);
    remove_SfrReg(&adres);
    remove_SfrReg(&trisccp);
    remove_SfrReg(&dataccp);
}
...
P16C716::P16C716(const char *_name )
    : P16C712(_name )
{
}
...
{
    P16x71x::create_sfr_map();
    add_SfrReg(&pwm1con, 0x18, RegisterValue(0,0));
    add_SfrReg(&eccpas, 0x19, RegisterValue(0,0));
...
P16F716::P16F716(const char *_name )
    : P16C712(_name ),
      eccpas(this, "eccpas" ),
...
P16C72::P16C72(const char *_name )
    : P16C62(_name ),
      adcon0(this,"adcon0" ),
      adcon1(this,"adcon1" ),
      adres(this,"adres" )
{
    ...
    pir2_2_reg = new PIR2v2(this,"pir2", &intcon_reg,&pie2);
...
P16C73::P16C73(const char *_name )
    : P16C63(_name ),
      adcon0(this,"adcon0" ),
      adcon1(this,"adcon1" ),
      adres(this,"adres" )
...
{
    add_SfrReg(pm_rd.get_reg_pmadr(),  0x10d);
    add_SfrReg(pm_rd.get_reg_pmadrh(), 0x10f);
    add_SfrReg(pm_rd.get_reg_pmdata(), 0x10c);
    add_SfrReg(pm_rd.get_reg_pmdath(), 0x10e);
    add_SfrReg(pm_rd.get_reg_pmcon1(), 0x18c);
...
P16F73::P16F73(const char *_name )
    : P16C73(_name ),
      pm_rd(this)
{
}
...
P16F73::~P16F73()
{
    remove_SfrReg(pm_rd.get_reg_pmadr());
    remove_SfrReg(pm_rd.get_reg_pmadrh());
    remove_SfrReg(pm_rd.get_reg_pmdata());
    remove_SfrReg(pm_rd.get_reg_pmdath());
    remove_SfrReg(pm_rd.get_reg_pmcon1());
}
...
P16C74::P16C74(const char *_name )
    : P16C65(_name ) ,
      adcon0(this,"adcon0" ),
      adcon1(this,"adcon1" ),
      adres(this,"adres" )
...
P16F74::P16F74(const char *_name )
    : P16C74(_name ),
      pm_rd(this)
{
}
