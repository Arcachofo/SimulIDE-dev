...
{
public:
    P10LF320(const char *_name=0 ) : P10F320(_name ){;}
    ~P10LF320(){;}
...
{
public:
    P10LF322(const char *_name=0 ) : P10F322(_name ){;}
    ~P10LF322(){;}
