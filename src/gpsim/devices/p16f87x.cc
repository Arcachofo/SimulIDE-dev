...
//========================================================================
P16F871::P16F871(const char *_name)
    : P16C64(_name) ,
      adcon0(this,"adcon0" ),
      adcon1(this,"adcon1" ),
      adres(this,"adres" ),
...
P16F873::P16F873(const char *_name )
    : P16C73(_name ),
      adresl(this,"adresl" )
{
    set_hasSSP();
...
P16F873A::P16F873A(const char *_name )
    : P16F873(_name ),
      comparator(this)
{
}
...
P16F876::P16F876(const char *_name )
    : P16C73(_name ),
      adresl(this,"adresl" )
{
}
...
P16F876A::P16F876A(const char *_name )
    : P16F873A(_name ),
      comparator(this)
{
}
...
P16F874::P16F874(const char *_name )
    : P16C74(_name ),
      comparator(this),
      adresl(this,"adresl")
{
...
P16F874A::P16F874A(const char *_name )
    : P16F874(_name ),
      comparator(this)
{
}
...
P16F877::P16F877(const char *_name )
    : P16F874(_name )
{
} 
...
P16F877A::P16F877A(const char *_name )
    : P16F874A(_name ),
      comparator(this)
{
}
