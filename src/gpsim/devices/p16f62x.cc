...
P16F62x::P16F62x(const char *_name)
...
void P16F62x::create_sfr_map()
{
    ...
    add_SfrReg(&comparator.cmcon, 0x1f, RegisterValue(0,0),"cmcon");
    add_SfrReg(&comparator.vrcon, 0x9f, RegisterValue(0,0),"vrcon");
...
P16F627::P16F627(const char *_name )
    : P16F62x(_name )
{
}
...
P16F628::P16F628(const char *_name )
    : P16F627(_name )
{
}
...
P16F648::P16F648(const char *_name )
    : P16F628(_name )
{
}
