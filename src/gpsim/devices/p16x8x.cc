...
P16X8X::P16X8X(const char *_name )
    : Pic14Bit(_name )
{
}
...
void P16X8X::create_sfr_map()
{
    ...
    add_SfrReg(get_eeprom()->get_reg_eedata(),  0x08);
    add_SfrReg(get_eeprom()->get_reg_eecon1(),  0x88, RegisterValue(0,0));

    add_SfrReg(get_eeprom()->get_reg_eeadr(),   0x09);
    add_SfrReg(get_eeprom()->get_reg_eecon2(),  0x89);
}
...
P16C84::P16C84(const char *_name )
    : P16X8X(_name )
{
}
...
P16F84::P16F84(const char *_name )
    : P16X8X(_name )
{
}
...
//========================================================================
//
P16F83::P16F83(const char *_name )
    : P16X8X(_name )
{
}
...
//========================================================================
P16CR83::P16CR83(const char *_name )
    : P16F83(_name )
{
}
...
//========================================================================
P16CR84::P16CR84(const char *_name )
    : P16F84(_name )
{
}
