...
public:
    ...
    //  SfrReg	slrcon;  // this register is a NOP in gpsim
    CCPTMRS	ccptmrs;
    PSTRCON	pstrcon;
    SR_MODULE	sr_module;
    SSP1_MODULE   ssp1;
...
public:
    ...
    virtual OSCCON * getOSCCON(void)	{ return new OSCCON_HS(this, "osccon" ); }

    virtual PROCESSOR_TYPE isa(){return _P18F26K22_;}
    P18F26K22(const char *_name=0 );
    ~P18F26K22();
    static Processor *construct(const char *name);
