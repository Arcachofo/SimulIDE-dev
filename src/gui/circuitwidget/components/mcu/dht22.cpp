...
new DoubProp  <Dht22>( "TempInc", tr("Temperature increment"),"C°", this, &Dht22::tempInc,  &Dht22::setTempInc ),
new DoubProp  <Dht22>( "HumiInc", tr("Humidity increment")   ,"%" , this, &Dht22::humidInc, &Dht22::setHumidInc ),
    }} );
}
Dht22::~Dht22(){}
