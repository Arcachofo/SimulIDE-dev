...
new StringProp<TextComponent>( "Color"  , tr("Background Color"),"", this, &TextComponent::colorStr, &TextComponent::setColorStr ),
...
new StringProp<TextComponent>( "Font_Color" , tr("Font Color"),""        , this, &TextComponent::fontColor, &TextComponent::setFontColor ),
