...
bool Processor::isIntArg64Register(unsigned char number, unsigned char arg) { return arg < 4; }

bool Processor::isFloatArg64Register(unsigned char number, unsigned char arg) { return arg < 4; }
...
void CriticalSection::enter() { EnterCriticalSection((CRITICAL_SECTION*)pLock); }
void CriticalSection::leave() { LeaveCriticalSection((CRITICAL_SECTION*)pLock); }
