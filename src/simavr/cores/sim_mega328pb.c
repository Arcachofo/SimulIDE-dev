...
const struct mcu_t {
	...
	.timer1 = {
        ...
        .cs = { AVR_IO_REGBIT( TCCR1B, CS10 )
              , AVR_IO_REGBIT( TCCR1B, CS11 )
	...
	.timer4 = {
        ...
        .wgm = { AVR_IO_REGBIT( TCCR4A, WGM40 )
               , AVR_IO_REGBIT( TCCR4A, WGM41 )
               , AVR_IO_REGBIT( TCCR4B, WGM12 )
               , AVR_IO_REGBIT( TCCR4B, WGM43 ) },
		.wgm_op = {
            [0]  = WGM_NORMAL16(),
            [1]  = WGM_FCPWM_8(),
            [2]  = WGM_FCPWM_9(),
