# 1 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/testVref.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/testVref.c" 2
# 28 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/testVref.c"
...
# 43 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/testVref.c" 2
# 58 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/testVref.c"
# 1 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/lcd_sintaxe_mikroc.c" 1
...
# 12 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/lcd_sintaxe_mikroc.c" 2
# 34 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/lcd_sintaxe_mikroc.c"
__bit RS;
...
void Lcd_Write_Nibble(uint8_t n) {
    ...
    RD3 = 0;
    _delay((unsigned long)((1)*(20000000UL/4000000.0)));
    RD3 = 1;
    _delay((unsigned long)((1)*(20000000UL/4000000.0)));
    RD3 = 0;
...
void Lcd_Init() {
    ...
    _delay((unsigned long)((40)*(20000000UL/4000.0)));
    Lcd_Cmd(3);
...
# 59 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/testVref.c" 2
# 71 "/media/user/software/simulide/simulide_lauchpad/1.0.0/resources/examples/Micro/Pic/Test/16F88x/16F887_Vref/sources/testVref.c"
...
void ItoStr(unsigned int valor,unsigned char tam, char * str, char volt, char dot){
    ...
    for(int k=0;k<tam;k++) str[k] = ' ';
    pos = (tam - 1);
    termo = valor;
    while(termo >= 10){
        digito = (unsigned char) (termo % 10);
        str[pos] = 48 + digito;
        pos--;
        if(pos==dot && volt){
            str[pos]=',';
