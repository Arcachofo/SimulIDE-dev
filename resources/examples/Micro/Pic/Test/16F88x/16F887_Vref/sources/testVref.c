...
void main() {
    ...
    // configura��o do conversor AD            - Configure the ADC module
    ADCON0bits.ADCS  = 0x02;        // Focs/32 - Select ADC clock
    ADCON1bits.VCFG1 = 0x01;        // Vss     - Configure vref-
    ADCON1bits.VCFG0 = 0x00;        // Vdd     - Configure vref+
    ADCON0bits.CHS   = 0x00;        // AN0     - Select ADC channel
    ADCON1bits.ADFM  = 0x01;        // Right   - Select result format
    ADCON0bits.ADON  = 0x01;        // On      - Turn on ADC module
