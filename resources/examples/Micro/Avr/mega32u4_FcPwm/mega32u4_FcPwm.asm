...
INITSYS:
;Source:F12L909S165I818
	ldi	SysValueCopy,0
	out	PORTB,SysValueCopy
;Source:F12L912S165I821
	ldi	SysValueCopy,0
	out	PORTC,SysValueCopy
;Source:F12L915S165I824
	ldi	SysValueCopy,0
	out	PORTD,SysValueCopy
;Source:F12L918S165I827
	ldi	SysValueCopy,0
	out	PORTE,SysValueCopy
;Source:F12L921S165I830
	ldi	SysValueCopy,0
...
;Source:F1L39S1I9
	...
	out	OCR0A,SysTemp1
;Source:F1L40S1I10
	ldi	SysCalcTempA,200
	in	SysCalcTempB,OCR0A
