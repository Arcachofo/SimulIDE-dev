...
INITTIMER0151:
;Source:F11L1467S151I112
	lds	SysCalcTempA,TMRSOURCE
	cpi	SysCalcTempA,2
	brne	ENDIF7
;Source:F11L1468S151I113
	ldi	SysValueCopy,7
	sts	TMRPRES,SysValueCopy
;Source:F11L1469S151I114
ENDIF7:
;Source:F11L1476S151I121
...
INITTIMER1:
;Source:F11L1582S152I101
	lds	SysValueCopy,TMRPRES
	sts	TMR1_TMP,SysValueCopy
;Source:F11L1583S152I102
	lds	SysCalcTempA,TMRSOURCE
	cpi	SysCalcTempA,2
	brne	ENDIF8
;Source:F11L1584S152I103
	ldi	SysValueCopy,7
	sts	TMR1_TMP,SysValueCopy
;Source:F11L1585S152I104
ENDIF8:
	ret
...
STARTTIMER:
;Source:F11L773S146I88
	lds	SysCalcTempA,TMRNUMBER
	tst	SysCalcTempA
	brne	ENDIF5
;Source:F11L774S146I89
	ldi	SysTemp2,248
	in	SysTemp3,TCCR0B
	...
	out	TCCR0B,SysTemp3
;Source:F11L775S146I90
ENDIF5:
;Source:F11L791S146I106
	lds	SysCalcTempA,TMRNUMBER
	cpi	SysCalcTempA,1
	brne	ENDIF6
;Source:F11L792S146I107
	ldi	SysTemp2,240
	in	SysTemp3,TCCR1
	and	SysTemp3,SysTemp2
	mov	SysTemp1,SysTemp3
